...
class UI {
    constructor(options = {}) {
        ...
        this.screen.key(["pageup"], () => {
            const height = typeof this.chatBox.height === "number"
                ? this.chatBox.height
    ...
    addMessage(role, content, isAppend = false) {
        ...
        const chatBoxWidth = typeof this.chatBox.width === "number"
            ? this.chatBox.width
        ...
        if (!isAppend) {
            ...
            const wrappedContent = this.wordWrap(content, typeof this.chatBox.width === "number"
